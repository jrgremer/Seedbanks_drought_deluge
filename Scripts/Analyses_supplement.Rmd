...
#aboveground:
#exclusion different from control at 1930m, no differences with addition
#seedbank: no significant differences, marginally sig diff between exclusion and control at 2179
...
simp_means = alldat_rel_wide %>%
  ...
  mutate(siglabel = case_when(
    ...
    type == "Aboveground" & elevation == 2179 & Treatment == "Water Exclusion" ~ "+"))
